...
<div id="home">
    <div id="left-panel">
              ...
              <div id="button">
               <a href="/login/landingpage"><button type="button" class="btn btn-outline-light" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">Buy Now!</button></a>
              </div>
    </div>
    <div id="right-panel">
         ...
         <div class="col-md-10">
             ...
             <div class="row p-2 bg-white border rounded mb-4">
               ...
               <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                   ...
                   <div class="d-flex flex-column mt-4"><a href="/login/landingpage" class="btn btn-success btn-sm">Buy Now!</a></div>
               </div>
           </div>
             @endforeach
         </div>
          ...
          <div class="card">
            <div class="d-flex justify-content-between p-3">
              ...
              <div
                ...
                <a href="/login/landingpage" class="text-white mb-0 small"><i class="fa-solid fa-cart-shopping"></i></a>
              </div>
            </div>
